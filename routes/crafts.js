...
const craftOps = {
  getAll() {
    return dbAsync.all(`
      ...
      FROM crafts c
      LEFT JOIN categories cat ON cat.craft_Id = c.id and cat.isActive = 1
      LEFT JOIN techniquesView t ON t.category_Id = cat.id and t.isActive = 1
